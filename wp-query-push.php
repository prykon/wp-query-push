...
/**
 * WP_Query_Push Name:       WP Query PushWP_Query_Push URI:        https://wpquerypush.com
...
function add_plugin_menu_page() {
    add_menu_page( 'WP Query Push', 'WP Query Push', 'manage_options', 'wp_query_push', 'render_plugin_content', 'dashicons-database-view' );
}
...
function enqueue_admin_scripts() {
    if ( is_admin() && ( isset( $_GET['page'] ) && $_GET['page'] === 'wp_query_push' ) ) {
